...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirme su correo electrónico — CSC',
  invite: 'Ha sido invitado al sistema CSC',
  magiclink: 'Su enlace de acceso — CSC',
  recovery: 'Restablecer su contraseña — CSC',
  email_change: 'Confirme su cambio de correo — CSC',
  reauthentication: 'Su código de verificación — CSC',
}
...
const SAMPLE_PROJECT_URL = "https://csc-onboard-pro.lovable.app"
